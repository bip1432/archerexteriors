...
$geojsonUrl = $this->Url->build('/geojson/southern_jersey_counties.geojson', ['fullBase' => false]);
$markerIconUrl = $this->Url->build('/img/map/marker/icon-archi-hq.png', ['fullBase' => true]);
?>
...
<script>
    ...
    function initMap() {
        ...
        const branchLocations = [{
            ...
            branch_name: 'Southern Jersey & Delaware Valley',
                ...
                .then(data => {
                    ...
                    data.features.forEach(feature => {
                        try {
                            ...
                            const stateName = stateCode === '34' ? 'New Jersey' :
