<?php
// Set Meta Tags
$this->set('title', 'Dominic Buonadonna | Your Trusted Exterior Home Improvement Specialist | Archer Exteriors');
...
$this->set('ogTitle', 'Dominic Buonadonna | Your Trusted Exterior Home Improvement Specialist | Archer Exteriors');
                    ...
                    <div class="left">
                        <div class="bio mb-4">
                            ...
                            <div class="desc">
                                ...
                                <p>Educating you every step of the way — because smart choices build stronger homes.</p>
