<?php
// Set Meta Tags
$this->set('title', 'Meet the Archer Exteriors Remodeling Sales Team | Your Home Exterior Experts');
$this->set('metaDescription', 'Meet Archer Exteriors’ trusted sales team—home exterior specialists with 40+ years experience, serving 22 states and 15K delighted clients.');
$this->set('metaKeywords', STATIC_KEYWORDS . ', Archer Exteriors Sales Team, Home Exterior Specialists, Exterior Remodeling Sales, Roofing Siding Sales Experts, Home Improvement Sales Team, Exterior Project Consultants, Trusted Exterior Contractors, Home Exteriors Sales, Neighborhood Exterior Experts, Archer Sales Team Experience');
$this->set('ogTitle', 'Meet the Archer Exteriors Remodeling Sales Team | Your Home Exterior Experts');
$this->set('ogDescription', 'Meet Archer Exteriors’ trusted sales team—home exterior specialists with 40+ years experience, serving 22 states and 15K delighted clients.');
        ...
        <div class="salesman_profile_item">
          <div class="inner-box">
            ...
            <div class="contents">
              ...
              <h6 class="serving"><i class="fi fi-rr-hand-back-point-right"></i> Serving South Jersey/Pennsylvania/Delaware</h6>
        ...
        <div class="salesman_profile_item">
          <div class="inner-box">
            ...
            <div class="contents">
              ...
              <h4 class="name">Scott Minghenelli</h4>
              <h6 class="designation">Home Exterior Specialist</h6>
              <h6 class="serving"><i class="fi fi-rr-hand-back-point-right"></i> Serving South Jersey/Pennsylvania/Delaware</h6>
              <p class="desc">More Than Exteriors — Helping Homeowners Make Smarter Decisions.</p>
            </div>
            <div class="mt-auto">
              <?= $this->Html->link(
                'View Profile<i class="flaticon-login"></i>',
                ['controller' => 'Teams', 'action' => 'scott'],
                ['class' => 'theme-btn sm', 'escape' => false]
              ) ?>
            </div>
          </div>
        ...
        <div class="salesman_profile_item">
          <div class="inner-box">
            ...
            <div class="contents">
              ...
              <h6 class="designation">Home Exterior Specialist</h6>
              <h6 class="serving"><i class="fi fi-rr-hand-back-point-right"></i> Serving Florida/Alabama</h6>
