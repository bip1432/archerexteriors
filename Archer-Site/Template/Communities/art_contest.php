...
<section class="artContest_hero">
  <div class="auto-container">
    <div class="row flex-column-reverse flex-lg-row gy-4 text-center text-lg-start">
      <div class="col-lg-6 align-self-center">
        <div class="contents">
          <h1 class="title">Color the World <br> with Archie!</h1>
          <p class="desc">An exciting national art contest for creative kids and teens, brought to you by Archer Exteriors.</p>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row gx-lg-5 gy-5">
      <div class="col-lg-6" style="position: relative; z-index:1;">
        ...
        <h2 class="title_2 mt-5">Submission Process</h2>
        <h4 class="title_4 mt-3">To enter, follow both steps below:</h4>
        <ul class="check_list mt-3 submission_process">
          ...
          <li class="two mb-3"><span class="number">2</span> <span>Post the artwork photo on your Facebook profile. Make sure to tag <b style="color: #ff5c5c;">@ArcherExteriors</b>, follow us, and use the hashtag <b style="color: #ff5c5c;">#ColorTheWorldWithArchie.</b> <i>(This helps us find and feature your submission!)</i></span></li>
        ...
        <div class="mt-5">
          <a href="javascript:void(0)" class="theme-btn sm" data-bs-toggle="modal" data-bs-target="#contestTermsModal" href="javascript:void(0)"><?= $this->Html->image('art-contest/svg/alert-sign.svg', ['alt' => 'Terms and Conditions of the Contest', 'width' => '24']) ?> Terms and Conditions of the Contest</a>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="row gy-4 artContest_ageGroup">
      <div class="col-xxl-3 col-md-6">
        <div class="item">
          <div class="item_icon">
            <?= $this->Html->image('art-contest/categories/crayons.png', [
              'class' => 'img-fluid',
              'alt' => 'Little Scribblers',
              'title' => 'Little Scribblers'
            ]) ?>
          </div>
      ...
      <div class="col-xxl-3 col-md-6">
        <div class="item">
          <div class="item_icon">
            <?= $this->Html->image('art-contest/categories/colored-pencil.png', [
              'class' => 'img-fluid',
              'alt' => 'Visioneers',
              'title' => 'Visioneers'
            ]) ?>
      ...
      <div class="col-xxl-3 col-md-6">
        <div class="item">
          <div class="item_icon">
            <?= $this->Html->image('art-contest/categories/oil-paint.png', [
              'class' => 'img-fluid',
              'alt' => 'Imagination Architects',
              'title' => 'Imagination Architects'
            ]) ?>
          </div>
      ...
      <div class="col-xxl-3 col-md-6">
        <div class="item">
          ...
          <div class="item_icon">
            <?= $this->Html->image('art-contest/categories/color-palette.png', [
              'class' => 'img-fluid',
              'alt' => 'Color Explorers',
...
<section class="section">
  <div class="container">
    <div class="row gy-4 gx-lg-5 text-center text-lg-start">
      ...
      <div class="col-lg-6 align-self-center">
        <h2 class="title_2">Drawing Medium</h2>
        <p class="mt-3">Submissions must be created using <b>traditional drawing or coloring tools</b> such
          as crayons, colored pencils, watercolor, or oil paint.</p>
        <p class="mt-4"><b>Digital artwork or AI-generated images will not be accepted.</b> Only
        ...
        <div class="mt-5">
          ...
          <p>Due to a conflict of interest, employees of Archer Exteriors and their immediate family members (defined as spouses, children, and siblings), as well as direct business partners and affiliates, are not eligible to participate in the contest. However, cousins and more distant relatives are welcome to enter and are not subject to this restriction.</p>
        </div>
      </div>
    </div>
  </div>
