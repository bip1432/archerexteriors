<?php
// Set Meta Tags
$this->set('title', 'Terms and Conditions | Archer Exteriors');
$this->set('metaDescription', 'Archer Exteriors - Terms and Conditions');
$this->set('metaKeywords', STATIC_KEYWORDS . ', Terms and Conditions, archerexteriors.com, Archer Exteriors');
$this->set('ogTitle', 'Terms and Conditions | Archer Exteriors');
$this->set('ogDescription', 'Archer Exteriors - Terms and Conditions');
$this->set('ogImage', DOMAIN . '/img/archerexteriors-insignia.png?' . time());
$this->set('ogType', 'website'); // For general info pages
$this->set('ogUrl', DOMAIN . '/terms-and-conditions'); // TODO: Change to the current page URL
?>
...
<section class="cms_hero">
    <div class="auto-container">
        <div class="contents text-center">
            ...
            <p class="desc">Last updated December 23, 2022</p>
        </div>
    </div>
</section>
...
<section class="section">
    <div class="auto-container">
        ...
        <h4 class="title_3 mb-4">TABLE OF CONTENTS</h4>
        <ul class="list-style-number ps-4 mb-5">
            <li>
        ...
        <h4 id="agreement" class="title_3 mt-5 mb-3 pt-5" style="scroll-margin-top: 150px;">1. AGREEMENT TO TERMS</h4>

        <p class="mb-3">These Terms of Use constitute a legally binding agreement made between you, whether personally or
            on behalf of an entity (“you”) and Archer Exteriors Inc. ("<b>Company</b>," “<b>we</b>," “<b>us</b>," or
            “<b>our</b>”), concerning your access to and use of the <a target="_blank"
                href="http://www.archerexteriors.com">http://www.archerexteriors.com</a> website as well as any other media
            form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto
            (collectively, the “Site”). We are registered in New Jersey, United States and have our registered office at
            __________, 341 Harding Highway, Pittsgrove, NJ 08318. You agree that by accessing the Site, you have read,
            understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF
            USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>

        <p class="mb-3">Supplemental terms and conditions or documents that may be posted on the Site from time to time
            are hereby expressly incorporated herein by reference. We reserve the right, in our sole discretion, to make
            ...
            notice of each such change. Please ensure that you check the applicable Terms every time you use our Site so
            that you understand which Terms apply. You will be subject to, and will be deemed to have been made aware of and
            to have accepted, the changes in any revised Terms of Use by your continued use of the Site after the date such
            revised Terms of Use are posted.</p>
        <p class="mb-3">The information provided on the Site is not intended for distribution to or use by any person or
        ...
        <p class="mb-3">The Site is not tailored to comply with industry-specific regulations (Health Insurance
            Portability and Accountability Act (HIPAA), Federal Information Security Management Act (FISMA), etc.), so if
            your interactions would be subjected to such laws, you may not use this Site. You may not use the Site in a way
            that would violate the Gramm-Leach-Bliley Act (GLBA).</p>
        <p class="mb-3">The Site is intended for users who are at least 18 years old. Persons under the age of 18 are not
            permitted to use or register for the Site.</p>



        <h4 id="ip" class="title_3 mt-5 mb-3 " style="scroll-margin-top: 150px;">2. INTELLECTUAL PROPERTY RIGHTS</h4>
        <p class="mb-3">Unless otherwise indicated, the Site is our proprietary property and all source code, databases,
        ...
        <p class="mb-3">Provided that you are eligible to use the Site, you are granted a limited license to access and
            use the Site and to download or print a copy of any portion of the Content to which you have properly gained
        ...
        <h4 id="userreps" class="title_3 mt-5 mb-3 " style="scroll-margin-top: 150px;">3. USER REPRESENTATIONS</h4>

        <p class="mb-3">By using the Site, you represent and warrant that: (1) you have the legal capacity and you agree
            to comply with these Terms of Use; (2) you are not a minor in the jurisdiction in which you reside; (3) you will
            not access the Site through automated or non-human means, whether through a bot, script, or otherwise; (4) you
            will not use the Site for any illegal or unauthorized purpose; and (5) your use of the Site will not violate any
            applicable law or regulation.</p>

        <p class="mb-3">If you provide any information that is untrue, inaccurate, not current, or incomplete, we have the
            right to suspend or terminate your account and refuse any and all current or future use of the Site (or any
            portion thereof).</p>

        <h4 id="prohibited" class="title_3 mt-5 mb-3 " style="scroll-margin-top: 150px;">4. PROHIBITED ACTIVITIES</h4>

        <p class="mb-3">You may not access or use the Site for any purpose other than that for which we make the Site
        ...
        <p class="mb-2">As a user of the Site, you agree not to:</p>

        <ul class="list-style-disc ps-4 mb-5">
        ...
        <h4 id="ugc" class="title_3 mt-5 mb-3 " style="scroll-margin-top: 150px;">5. USER GENERATED CONTRIBUTIONS</h4>

        <p class="mb-3">The Site does not offer users to submit or post content. We may provide you with the opportunity
            to create, submit, post, display, transmit, perform, publish, distribute, or broadcast content and materials to
            us or on the Site, including but not limited to text, writings, video, audio, photographs, graphics, comments,
            ...
            you thereby represent and warrant that:</p>

        <ul class="list-style-disc ps-4 mb-4">
        ...
        <p class="mb-3">Any use of the Site in violation of the foregoing violates these Terms of Use and may result in,
            among other things, termination or suspension of your rights to use the Site.</p>


        <h4 id="license" class="title_3 mt-5 mb-3 " style="scroll-margin-top: 150px;">6. CONTRIBUTION LICENSE</h4>
        <p class="mb-3">You agree that we may access, store, process, and use any information and personal data that you
            provide following the terms of the Privacy Policy and your choices (including settings).</p>
        <p class="mb-3">By submitting suggestions or other feedback regarding the Site, you agree that we can use and
            share such feedback for any purpose without compensation to you.</p>
        <p class="mb-3">We do not assert any ownership over your Contributions. You retain full ownership of all of your
            ...
            any area on the Site. You are solely responsible for your Contributions to the Site and you expressly agree to
            exonerate us from any and all responsibility and to refrain from any legal action against us regarding your
            Contributions.</p>

        <h4 id="mobile" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">7. MOBILE APPLICATION LICENSE</h4>
        <h5 class="title_4 mb-2">Use License</h5>
        <p class="mb-4">If you access the Site via a mobile application, then we grant you a revocable, non-exclusive,
            ...
            the terms and conditions of this mobile application license contained in these Terms of Use. You shall not: (1)
            except as permitted by applicable law, decompile, reverse engineer, disassemble, attempt to derive the source
            code of, or decrypt the application; (2) make any modification, adaptation, improvement, enhancement,
            ...
            (including any notice of copyright or trademark) posted by us or the licensors of the application; (5) use the
            application for any revenue generating endeavor, commercial enterprise, or other purpose for which it is not
            designed or intended; (6) make the application available over a network or other environment permitting access
            or use by multiple devices or users at the same time; (7) use the application for creating a product, service,
            ...
            use with the application.</p>

        <h5 class="title_4 mb-2">Apple and Android Devices</h5>
        <p class="mb-3">The following terms apply when you use a mobile application obtained from either the Apple Store
            or Google Play (each an “App Distributor”) to access the Site: (1) the license granted to you for our mobile
            ...
            conform to any applicable warranty, you may notify the applicable App Distributor, and the App Distributor, in
            accordance with its terms and policies, may refund the purchase price, if any, paid for the mobile application,
            and to the maximum extent permitted by applicable law, the App Distributor will have no other warranty
            obligation whatsoever with respect to the mobile application; (4) you represent and warrant that (i) you are not
            ...
            prohibited or restricted parties; (5) you must comply with applicable third-party terms of agreement when using
            the mobile application, e.g., if you have a VoIP application, then you must not be in violation of their
            wireless data service agreement when using the mobile application; and (6) you acknowledge and agree that the
            App Distributors are third-party beneficiaries of the terms and conditions in this mobile application license
            contained in these Terms of Use, and that each App Distributor will have the right (and will be deemed to have
            accepted the right) to enforce the terms and conditions in this mobile application license contained in these
            Terms of Use against you as a third-party beneficiary thereof.</p>


        <h4 id="submissions" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">8. SUBMISSIONS</h4>
        <p class="mb-3">You acknowledge and agree that any questions, comments, suggestions, ideas, feedback, or other
            information regarding the Site ("Submissions") provided by you to us are non-confidential and shall become our
            sole property. We shall own exclusive rights, including all intellectual property rights, and shall be entitled
        ...
        <h4 id="thirdparty" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">9. THIRD-PARTY WEBSITE AND
            CONTENT</h4>
        <p class="mb-3">The Site may contain (or you may be sent via the Site) links to other websites ("Third-Party
        ...
        <h4 id="sitemanage" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">10. SITE MANAGEMENT</h4>
        <p class="mb-3">We reserve the right, but not the obligation, to: (1) monitor the Site for violations of these
            Terms of Use; (2) take appropriate legal action against anyone who, in our sole discretion, violates the law or
            these Terms of Use, including without limitation, reporting such user to law enforcement authorities; (3) in our
            sole discretion and without limitation, refuse, restrict access to, limit the availability of, or disable (to
            ...
            and content that are excessive in size or are in any way burdensome to our systems; and (5) otherwise manage the
            Site in a manner designed to protect our rights and property and to facilitate the proper functioning of the
            Site.</p>

        <h4 id="privacypolicy1" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">11. PRIVACY POLICY</h4>
        <p class="mb-3">We care about data privacy and security. Please review our Privacy Policy: <a target="_blank"
                href="./privacy-policy.html">https://archerexteriors.com/privacy-policy</a>. By using the Site, you agree to
            be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Site is
            ...
            and you agree to have your data transferred to and processed in the United States. </p>

        <h4 id="terms" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">12. TERM AND TERMINATION</h4>
        <p class="mb-3">These Terms of Use shall remain in full force and effect while you use the Site. WITHOUT LIMITING
            ANY OTHER PROVISION OF THESE TERMS OF USE, WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR
        ...
        <p class="mb-3">If we terminate or suspend your account for any reason, you are prohibited from registering and
        ...
        <h4 id="modifications" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">13. MODIFICATIONS AND
            INTERRUPTIONS</h4>
        <p class="mb-3">We reserve the right to change, modify, or remove the contents of the Site at any time or for any
            ...
            of the Site.</p>
        <p class="mb-3">We cannot guarantee the Site will be available at all times. We may experience hardware, software,
        ...
        <h4 id="law" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">14. GOVERNING LAW</h4>
        <p class="mb-3">These Terms of Use and your use of the Site are governed by and construed in accordance with the
            laws of the State of New Jersey applicable to agreements made and to be entirely performed within the State of
            New Jersey, without regard to its conflict of law principles.</p>


        <h4 id="disputes" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">15. DISPUTE RESOLUTION</h4>
        <h5 class="title_4 mb-2">Informal Negotiations</h5>
        <p class="mb-4">To expedite resolution and control the cost of any dispute, controversy, or claim related to these
        ...
        <h5 class="title_4 mb-2">Binding Arbitration</h5>
        <p class="mb-3">If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except
            those Disputes expressly excluded below) will be finally and exclusively resolved through binding arbitration.
            ...
            ("AAA Consumer Rules"), both of which are available at the AAA website: <a target="_blank"
                href="https://www.adr.org/">www.adr.org</a>. Your arbitration fees and your share of arbitrator compensation
            shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. If such
            costs are determined by the arbitrator to be excessive, we will pay all arbitration fees and expenses. The
            ...
            in Salem, New Jersey. Except as otherwise provided herein, the Parties may litigate in court to compel
        ...
        <p class="mb-3">If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be
            commenced or prosecuted in the state and federal courts located in Salem, New Jersey, and the Parties hereby
            consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to
            venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on
            Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) is
            excluded from these Terms of Use.</p>
        <p class="mb-4">In no event shall any Dispute brought by either Party related in any way to the Site be commenced
        ...
        <h5 class="title_4 mb-2">Restrictions</h5>
        <p class="mb-5">The Parties agree that any arbitration shall be limited to the Dispute between the Parties
        ...
        <h5 class="title_4 mb-2">Exceptions to Informal Negotiations and Arbitration</h5>
        <p class="mb-5">The Parties agree that the following Disputes are not subject to the above provisions concerning
            informal negotiations and binding arbitration: (a) any Disputes seeking to enforce or protect, or concerning the
        ...
        <h4 id="corrections" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">16. CORRECTIONS</h4>
        ...
        <h4 id="disclaimer" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">17. DISCLAIMER</h4>
        ...
        <h4 id="liability" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">18. LIMITATIONS OF LIABILITY</h4>
        <p>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT,
            ...
            IF ANY, BY YOU TO US DURING THE six (6) mONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN US STATE LAWS
        ...
        <h4 id="indemnification" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">19. INDEMNIFICATION</h4>
        ...
        <h4 id="userdata" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">20. USER DATA</h4>
        ...
        <h4 id="electronic" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">21. ELECTRONIC COMMUNICATIONS,
            TRANSACTIONS, AND SIGNATURES</h4>
        ...
        <h4 id="california" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">22. CALIFORNIA USERS AND
            RESIDENTS</h4>
        ...
        <h4 id="misc" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">23. MISCELLANEOUS</h4>
        ...
        <h4 id="contact" class="title_3 mt-5 mb-4 " style="scroll-margin-top: 150px;">24. CONTACT US</h4>
        <p class="mb-3">In order to resolve a complaint regarding the Site or to receive further information regarding use
            of the Site, please contact us at:</p>
        <h5 class="title_4 mb-1">Archer Exteriors Inc.</h5>
        <h5 class="title_4 mb-1">341 Harding Highway</h5>
        <h5 class="title_4 mb-1">Pittsgrove, NJ 08318</h5>
        <h5 class="title_4 mb-1">United States</h5>
        <h5 class="title_4 mb-1">Phone: (866) 272 4398</h5>
        <h5 class="title_4 mb-1">info@archerexteriors.com</h5>
