...
<section class="page_hero reviews">
  <div class="auto-container">
    <div class="contents text-center">
      <h1 class="title">Trusted. Rated. Recommended.</h1>
      <p class="desc">See what homeowners are saying about their Archer experience.</p>
    </div>
  </div>
</section>
<!-- Hero-section end -->
...
<section class="section">
  <div class="container">
    <div class="text-center mb-5">
      <?= $this->Html->link(
        $this->Html->image(
          'archer-applause/archer-exteriors-applause-banner-lg.jpg',
          [
            'class' => 'img-fluid rad_6 banner_hover',
            'alt' => 'Real Homes. Real Results. Real Stories.',
            'title' => 'Real Homes. Real Results. Real Stories.'
          ]
        ),
      ...
      <?= $this->Html->link(
        $this->Html->image(
          'archer-applause/archer-exteriors-applause-banner-sm.jpg',
          [
            'class' => 'img-fluid rad_6 banner_hover',
            'alt' => 'Real Homes. Real Results. Real Stories.',
            'title' => 'Real Homes. Real Results. Real Stories.'
