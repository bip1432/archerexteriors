<?php
// Set Meta Tags
$this->set('title', 'Thank You for Your Request | Archer Exteriors');
...
$this->set('ogTitle', 'Thank You for Your Request | Archer Exteriors');
...
$this->set('ogUrl', DOMAIN . '/thank-you'); // TODO: Change to the current page URL
?>
...
<section class="section light text-center thank_you_contents">
    <div class="auto-container">
        <div class="header">
            ...
            <h2>Your estimate request has been submitted successfully.</h2>
        </div>
        ...
        <p class="desc">We appreciate your interest in our services.</p>
