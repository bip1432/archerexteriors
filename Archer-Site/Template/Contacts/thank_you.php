<?php
// Set Meta Tags
$this->set('title', 'Thank You for Your Contact Form Submission | Archer Exteriors');
...
$this->set('ogTitle', 'Thank You for Your Contact Form Submission | Archer Exteriors');
...
$this->set('ogUrl', DOMAIN . '/contacts/thank-you'); // TODO: Change to the current page URL
?>
...
<section class="section light text-center thank_you_contents">
    <div class="auto-container">
        ...
        <p class="desc">We have received your contact form submission and will get back to you within 2 or 3 business days.</p>
