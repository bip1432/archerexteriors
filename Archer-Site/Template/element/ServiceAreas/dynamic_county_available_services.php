...
// Get county state
if (!empty($stateIso)) {
  $countyState = $countyName . ', ' . $stateIso;
} else {
  $countyState = $countyName;
}
?>
<div class="container">
  <div class="sec-title text-center">
    <h6><i class="flaticon-roof"></i>Available Services</h6>
    <h2>Professional Exterior Services in <span><?= h($countyName) ?></span></h2>
  ...
  <div class="service_item odd">
    ...
    <div class="service_details">
      <div class="service_details_inner">
        <h2 class="title"><?= $this->Html->link('Roof Replacement in ' . $countyState, '/service-area/' . $stateSlug . '/roofing-in-' . $countySlug, ['class' => 'link']) ?></h2>

        <p>Looking for reliable roof replacement in <?= $countyState ?>? Our expert team provides high-quality roofing solutions to protect your home and enhance curb appeal. We work with durable materials and skilled craftsmanship to ensure long-lasting results. Whether your roof is damaged, aged, or simply in need of an upgrade, we deliver professional service tailored to your needs. Trust us to keep your home safe, energy-efficient, and beautiful year-round.</p>
  ...
  <div class="service_item even">
    ...
    <div class="service_details">
      <div class="service_details_inner">
        <h2 class="title"><?= $this->Html->link('Siding Replacement in ' . $countyState, '/service-area/' . $stateSlug . '/siding-in-' . $countySlug, ['class' => 'link']) ?></h2>

        <p>Upgrade your home's exterior with professional siding replacement in <?= $countyState ?>. Our team installs durable, weather-resistant siding that not only protects your property but also boosts curb appeal. We offer a wide range of styles and colors to match your home's design. With expert craftsmanship and quality materials, we ensure lasting beauty and performance. Transform your home with siding that's built to stand up to <?= $countyState ?>'s climate.</p>
  ...
  <div class="service_item odd">
    ...
    <div class="service_details">
      <div class="service_details_inner">
        <h2 class="title"><?= $this->Html->link('Window Replacement in ' . $countyState, '/service-area/' . $stateSlug . '/windows-in-' . $countySlug, ['class' => 'link']) ?></h2>

        <p>Enhance your home's comfort and efficiency with professional window replacement in <?= $countyState ?>. Our high-quality windows improve insulation, reduce energy costs, and add lasting style to your property. From modern designs to classic styles, we offer options to fit every home. With expert installation and durable materials, we ensure a perfect fit and long-term performance. Trust us to brighten your home with windows that combine beauty, strength, and energy savings.</p>
  ...
  <div class="service_item odd">
    ...
    <div class="service_details">
      <div class="service_details_inner">
        <h2 class="title"><?= $this->Html->link('Gutter Replacement Services in ' . $countyState, '/service-area/' . $stateSlug . '/gutters-in-' . $countySlug, ['class' => 'link']) ?></h2>
