<?php
$this->set('title', 'Lynn Haven, Florida | Roofing & Siding | Archer Exteriors');
$this->set('metaDescription', 'Archer Exteriors - Lynn Haven, Florida');
...
$this->set('ogTitle', 'Lynn Haven, Florida | Roofing & Siding | Archer Exteriors');
$this->set('ogDescription', 'Archer Exteriors - Lynn Haven, Florida');
$this->set('ogImage', DOMAIN . '/img/archerexteriors-insignia.png?' . time());
$this->set('ogType', 'website'); // For general info pages
$this->set('ogUrl', DOMAIN . '/service-areas/lynn-haven-florida'); // TODO: Change to the current page URL
?>
<?php
...
<section class="breadcrumb_section">
    <div class="container">
        <div class="breadcrumb_wrap">
            ...
            <a class="item" href="#">Lynn Haven, Florida</a>
        </div>
    </div>
</section>
        ...
        <div class="row gx-lg-5 gy-5">
            <div class="col-lg-7">
                <div class="sec-title">
                    ...
                    <h2><span>LYNN HAVEN, FLORIDA</span></h2>
                </div>
    ...
    <div class="container">
        <div class="row gy-5 text-center text-lg-start">
            <div class="col-lg-6 align-self-center">
                ...
                <div class="mapapi-app" data-map-slug="lynn-haven-florida-counties" data-map-domain="<?= h(DOMAIN) ?>" data-mapapi-app-lazy data-height="400px"></div>
            </div>
            ...
            <div class="col-lg-6 align-self-center">
                ...
                <p class="mb-4">Discover the best roofing, siding, and window replacement services in Florida. Archer
                    Exteriors provides expert solutions tailored to your needs.</p>
                <p>At Archer Exteriors, we take pride in providing our expert services to a wide range of communities near Florida. Whether you reside in a bustling city or a quaint town, our team is dedicated to delivering
