<?php
$this->set('title', 'Southern Jersey & Delaware Valley | Roofing & Siding | Archer Exteriors');
$this->set('metaDescription', 'Archer Exteriors - Southern Jersey & Delaware Valley');
...
$this->set('ogTitle', 'Southern Jersey & Delaware Valley | Roofing & Siding | Archer Exteriors');
$this->set('ogDescription', 'Archer Exteriors - Southern Jersey & Delaware Valley');
$this->set('ogImage', DOMAIN . '/img/archerexteriors-insignia.png?' . time());
$this->set('ogType', 'website'); // For general info pages
$this->set('ogUrl', DOMAIN . '/service-areas/southern-jersey-delaware-valley'); // TODO: Change to the current page URL
?>
<?php
...
<section class="serviceAreaDetails_hero branch">
    <div class="container h-100">
        <div class="content-box">
            <h2 class="title">SOUTHERN JERSEY & <br> DELAWARE VALLEY</h2>
        </div>
    </div>
</section>
<!-- banner-section end -->
...
<section class="breadcrumb_section">
    <div class="container">
        <div class="breadcrumb_wrap">
            ...
            <a class="item" href="#">Southern Jersey & Delaware Valley</a>
        </div>
    </div>
</section>
        ...
        <div class="row gx-lg-5 gy-5">
            <div class="col-lg-7">
                <div class="sec-title">
                    ...
                    <h2><span>SOUTHERN JERSEY & <br> DELAWARE VALLEY</span></h2>
                </div>
