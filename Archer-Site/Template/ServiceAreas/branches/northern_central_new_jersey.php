<?php
$this->set('title', 'Northern & Central New Jersey | Roofing & Siding | Archer Exteriors');
$this->set('metaDescription', 'Archer Exteriors - Northern & Central New Jersey');
...
$this->set('ogTitle', 'Northern & Central New Jersey | Roofing & Siding | Archer Exteriors');
$this->set('ogDescription', 'Archer Exteriors - Northern & Central New Jersey');
$this->set('ogImage', DOMAIN . '/img/archerexteriors-insignia.png?' . time());
$this->set('ogType', 'website'); // For general info pages
$this->set('ogUrl', DOMAIN . '/service-areas/northern-central-new-jersey'); // TODO: Change to the current page URL
?>
<?php
...
<section class="serviceAreaDetails_hero branch">
    <div class="container h-100">
        <div class="content-box">
            <h2 class="title">NORTHERN & CENTRAL <br> NEW JERSEY</h2>
        </div>
    </div>
</section>
<!-- banner-section end -->
...
<section class="breadcrumb_section">
    <div class="container">
        <div class="breadcrumb_wrap">
            ...
            <a class="item" href="#">Northern & Central New Jersey</a>
        </div>
    </div>
</section>
        ...
        <div class="row gx-lg-5 gy-5">
            <div class="col-lg-7">
                <div class="sec-title">
                    ...
                    <h2><span>NORTHERN & CENTRAL <br> NEW JERSEY</span></h2>
                </div>
    ...
    <div class="container">
        <div class="row gy-5 text-center text-lg-start">
            <div class="col-lg-6 align-self-center">
                <!-- Map Container: Northern & Central New Jersey Counties -->
                <div class="mapapi-app" data-map-slug="northern-jersey-counties" data-map-domain="<?= h(DOMAIN) ?>" data-mapapi-app-lazy data-height="400px"></div>
            </div>
            ...
            <div class="col-lg-6 align-self-center">
                ...
                <p class="mb-4">Discover the best roofing, siding, and window replacement services in Northern & Central New Jersey. Archer
                    Exteriors provides expert solutions tailored to your needs.</p>
                <p>At Archer Exteriors, we take pride in providing our expert services to a wide range of communities near Northern & Central New Jersey. Whether you reside in a bustling city or a quaint town, our team is dedicated to delivering
