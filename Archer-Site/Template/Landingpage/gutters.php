<?php
// Set Meta Tags
$this->set('title', 'Seamless Gutter Installation & Protection | Archer Exteriors');
...
$this->set('ogTitle', 'Seamless Gutter Installation & Protection | Archer Exteriors');
$this->set('ogDescription', 'Archer Exteriors - Your trusted partner for gutter installation services.');
$this->set('ogImage', DOMAIN . '/img/archerexteriors-insignia.png?' . time());
$this->set('ogType', 'website'); // For general info pages
$this->set('ogUrl', DOMAIN . '/gutter-service'); // TODO: Change to the current page URL
?>

<!-- banner-section -->
<section class="page_hero_v2 lp gutter bg_right">
  <div class="inner_content">
    <div class="image-layer">
    </div>
    <?= $this->Html->image('landing-pages/gutter/archer-exteriors-hero-banner-gutters-mobile.jpg', [
      'class' => 'img-fluid d-lg-none mb-4',
      'alt' => 'Seamless Gutters. Stress-Free Living',
      'title' => 'Seamless Gutters. Stress-Free Living'
    ]) ?>
      ...
      <div class="row clearfix">
        <div class="col-lg-7 col-md-12 offset-lg-5 content-column">
          <div class="content-box">
            ...
            <p class="mb-0">Quality gutters help prevent foundation issues, roof leaks, and landscape erosion.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row gx-lg-5 gy-5">
      <div class="col-xl-7 text-md-start text-center">
        ...
        <div class="roof_layer_wrap mb-5">
          <div class="content" style="flex: 0 70%;">
            <h3 class="title_2">Gutter Installation and Repair You Can Trust</h3>
            <p>Clogged or overflowing gutters can lead to costly damage to your roof, siding, and foundation.
              With over 40 years of expertise, Archer Exteriors delivers top-quality gutter protection, installation,
              and
              repair using premium materials and expert craftsmanship.</p>
            <p class="mt-3">We use high-quality, low-maintenance materials that offer long-lasting performance and
              style. From
              composite options to traditional wood finishes, every deck is tailored to meet your needs and blend with
              your home's exterior. We aim to create a space that feels like a natural extension of your home and
              gives
              you years of worry-free enjoyment.</p>
          </div>
          <div class="img">
            <?= $this->Html->image('landing-pages/gutter/gutter-elements.png', [
              'class' => 'img-fluid',
              'alt' => 'Gutter Installation and Repair You Can Trust',
              'title' => 'Gutter Installation and Repair You Can Trust'
            ]) ?>
          </div>
        </div>
      ...
      <div class="col-xl-5">
        <?= $this->element('forms/form_free_estimate', ['formId' => '26', 'formKey' => 'lpgutter4d9bce4781439d22a06d1b59a5f2c747']) ?>
      </div>
    </div>
  </div>
</section>
