<?php
// Set Meta Tags
$this->set('title', 'Energy-Efficient Window Replacement & Installation | Archer Exteriors');
...
$this->set('ogTitle', 'Energy-Efficient Window Replacement & Installation | Archer Exteriors');
$this->set('ogDescription', 'Archer Exteriors - Your trusted partner for premium windows solutions.');
$this->set('ogImage', DOMAIN . '/img/archerexteriors-insignia.png?' . time());
$this->set('ogType', 'website'); // For general info pages
$this->set('ogUrl', DOMAIN . '/window-service'); // TODO: Change to the current page URL
?>
<!-- banner-section -->
<section class="page_hero_v2 lp window bg_right">
  <div class="inner_content">
    <div class="image-layer">
    </div>
    <?= $this->Html->image('landing-pages/window/archer-exteriors-hero-banner-windows-mobile.jpg', [
      'class' => 'img-fluid d-lg-none mb-4',
      'alt' => 'Energy-Efficient Windows Installed Right',
      'title' => 'Energy-Efficient Windows Installed Right'
    ]) ?>
      ...
      <div class="row clearfix">
        <div class="col-lg-7 col-md-12 offset-lg-5 content-column">
          <div class="content-box">
            ...
            <p class="mb-0">Choose from OKNA and ProVia windows, custom-fit for your home and expertly installed for lasting comfort.</p>
          </div>
        </div>
      </div>
    </div>
...
<section class="section light service_details" id="getFreeEstimate">
  <div class="container">
    <div class="row gx-lg-5 gy-5">
      ...
      <div class="col-xl-5">
        <?= $this->element('forms/form_free_estimate', ['formId' => '23', 'formKey' => 'lpwindowe5ca0a96bbc83fff538c0ce764647e25']) ?>
      </div>
    </div>
  </div>
</section>
