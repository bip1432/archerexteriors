<?php
// Set Meta Tags
$this->set('title', 'Custom Deck Design & Installation Services | Archer Exteriors');
...
$this->set('ogTitle', 'Custom Deck Design & Installation Services | Archer Exteriors');
$this->set('ogDescription', 'Archer Exteriors - Your trusted partner for premium deck solutions.');
$this->set('ogImage', DOMAIN . '/img/archerexteriors-insignia.png?' . time());
$this->set('ogType', 'website'); // For general info pages
$this->set('ogUrl', DOMAIN . '/deck-service'); // TODO: Change to the current page URL
?>

<!-- banner-section -->
<section class="page_hero_v2 lp deck">
  <div class="inner_content">
    <div class="image-layer">
    </div>
    <?= $this->Html->image('landing-pages/deck/archer-exteriors-hero-banner-decks-mobile.jpg', [
      'class' => 'img-fluid d-lg-none mb-4',
      'alt' => 'Picture It. Build It. Love It',
      'title' => 'Picture It. Build It. Love It'
    ]) ?>
    <div class="auto-container">
      <div class="row clearfix">
        <div class="col-lg-7 col-md-12 content-column">
          <div class="content-box">
            <h1>Picture It. Build It. Love It</h1>
            <p class="mb-0">From cozy spaces to multi-level layouts, we design and build decks that bring your outdoor vision to
              life.</p>
          </div>
        </div>
      </div>
...
<section class="section light service_details" id="getFreeEstimate">
  <div class="container">
    <div class="row gx-lg-5 gy-5">
      ...
      <div class="col-xl-5">
        <?= $this->element('forms/form_free_estimate', ['formId' => '25', 'formKey' => 'lpdeck9b13918b41850da527f671342c6e11b2']) ?>
      </div>
    </div>
  </div>
</section>
