    ...
    <div class="row gy-5">
      <div class="col-lg-6 col-md-12 align-self-center">
        <div class="sec-title">
          ...
          <p class="desc" style="max-width: 500px;">We walk you through everything during your estimate. We want to help you get what you need.</p>
        </div>
        ...
        <div class="box_lists">
          <div class="item">
            ...
            <div class="contents">
              Get pre-qualified without any impact on your credit.
            </div>
          </div>
          ...
          <div class="item">
            ...
            <div class="contents">
              Browse offers tailor made for you (based on your credit).
            </div>
          </div>
          ...
          <div class="item">
            ...
            <div class="contents">
              Choose the fixed term and monthly payment that fits your needs.
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 col-md-12 image-column">
        <?= $this->Html->image('finance-options/how-it-works.jpg', [
          'class' => 'rad_4',
  ...
  <div class="container">
    <div class="row gy-5">
      ...
      <div class="col-lg-6 col-md-12 align-self-center">
        ...
        <p class="mt-4" style="font-size: 12px; line-height: 20px;">*Archer Exterior is neither a lender nor a broker. All financing is provided by 3rd party lending institutions under the terms and conditions of each lender. All applications are subject to approval through credit, income, and residency verification. All advertised finance terms, rates and payments are subject to change without notice. Advertised terms are solely to be used as estimating tools, actual terms will be disclosed at time of approval. Not all applications will be approved for all programs. Archer Exteriors does not assist with, counsel, or negotiate financing other than submitting credit applications on behalf of our customers to the lender. Approved applications become customers of the lender and will make payments directly to lender. Lender has final say to approve or decline of an application based on fair lending guidelines.</p>
      </div>
    </div>
  </div>
</section>
